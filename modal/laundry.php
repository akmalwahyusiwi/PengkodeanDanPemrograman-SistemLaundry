			...
			<div class="modal-body">
				<form class="form-horizontal" role="form" id="form-new-laun">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="Nama_Pelanggan" placeholder="Enter customer name" required>
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Urutan#:</label>
				    <div class="col-sm-9">
				      <input type="Urutan" class="form-control" id="Urutan" placeholder="Enter priority number" required>
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Berat:</label>
				    <div class="col-sm-9">
				      <input type="number" step="any" class="form-control" id="Berat" placeholder="Enter laundry weight" required>
				    </div>
				  </div>
				  <div class="form-group">
